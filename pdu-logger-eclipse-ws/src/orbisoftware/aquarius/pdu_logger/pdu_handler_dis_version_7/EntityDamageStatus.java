...
public class EntityDamageStatus {
   ...
   static public void processPDU(DatagramPacket packet, int pduCounter) {
      ...
      short length = 0;
      byte pduStatus = 0;
      short damagedEntityIDSiteNum = 0;
      short damagedEntityIDAppNum = 0;
      short damagedEntityIDEntNum = 0;
      short padding1;
      short padding2;
      short numDamDescRecords = 0;
      ...
      try {
         ...
         din.skipBytes(12);
         damagedEntityIDSiteNum = din.readShort();
         damagedEntityIDAppNum = din.readShort();
         damagedEntityIDEntNum = din.readShort();
         padding1 = din.readShort();
         padding2 = din.readShort();
         numDamDescRecords = din.readShort();     
         ...
         System.out.println(LoggerUtil.prettyPrintField("damagedEntityIDSiteNum") + damagedEntityIDSiteNum);
         System.out.println(LoggerUtil.prettyPrintField("damagedEntityIDAppNum") + damagedEntityIDAppNum);
         System.out.println(LoggerUtil.prettyPrintField("damagedEntityIDEntNum") + damagedEntityIDEntNum);
         System.out.println(LoggerUtil.prettyPrintField("numDamDescRecords") + numDamDescRecords);
         
         for (int i = 0; i < numDamDescRecords; i++) {
