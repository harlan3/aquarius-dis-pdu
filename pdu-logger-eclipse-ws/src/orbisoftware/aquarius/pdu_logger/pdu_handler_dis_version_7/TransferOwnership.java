...
public class TransferOwnership {
   ...
   static public void processPDU(DatagramPacket packet, int pduCounter) {
      ...
      byte transferType = 0;
      short transferEntIDSiteNum = 0;
      short transferEntIDAppNum = 0;
      short transferEntIDEntNum = 0;
      ...
      try {
         ...
         transferType = din.readByte();
         transferEntIDSiteNum = din.readShort();
         transferEntIDAppNum = din.readShort();
         transferEntIDEntNum = din.readShort();
         numberRecordSets = din.readInt();
         ...
         System.out.println(LoggerUtil.prettyPrintField("transferType") + transferType);
         System.out.println(LoggerUtil.prettyPrintField("transferEntIDSiteNum") + transferEntIDSiteNum);
         System.out.println(LoggerUtil.prettyPrintField("transferEntIDAppNum") + transferEntIDAppNum);
         System.out.println(LoggerUtil.prettyPrintField("transferEntIDEntNum") + transferEntIDEntNum);
         System.out.println(LoggerUtil.prettyPrintField("numberRecordSets") + numberRecordSets);
