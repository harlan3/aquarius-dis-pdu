...
public class IntercomSignal {
   ...
   static public void processPDU(DatagramPacket packet, int pduCounter) {
      ...
      short length = 0;
      byte pduStatus = 0;
      short intercomRefIDSiteNum = 0;
      short intercomRefIDAppNum = 0;
      short intercomRefIDRefNum = 0;
      short intercomNum = 0;
      ...
      try {
         ...
         intercomRefIDSiteNum = din.readShort();
         intercomRefIDAppNum = din.readShort();
         intercomRefIDRefNum = din.readShort();
         intercomNum = din.readShort();
         ...
         System.out.println(LoggerUtil.prettyPrintField("intercomRefIDSiteNum") + intercomRefIDSiteNum);
         System.out.println(LoggerUtil.prettyPrintField("intercomRefIDAppNum") + intercomRefIDAppNum);
         System.out.println(LoggerUtil.prettyPrintField("intercomRefIDRefNum") + intercomRefIDRefNum);
         System.out.println(LoggerUtil.prettyPrintField("intercomNum") + intercomNum);
         ...
         for (int i=0; i < dataLength; i++) {
            ...
            System.out.println(LoggerUtil.prettyPrintField("data") + data);
         }
