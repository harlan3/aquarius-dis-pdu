...
public class ElectromagneticEmission {
   ...
   static public void processPDU(DatagramPacket packet, int pduCounter) {
      ...
      byte beamStatus = 0;
      byte jammingTechKind = 0;
      byte jammingTechCategory = 0;
      byte jammingTechSubcategory = 0;
      byte jammingTechSpec = 0;
      short trackJamSite = 0;
      short trackJamApp = 0;
      short trackJamEntity = 0;
      byte trackJamEmitter = 0;
      byte trackJamBeamNumber = 0;
      ...
      try {
         ...
         for (int i = 0; i < numberOfSystems; i++) {
            ...
            for (int j = 0; j < numberOfBeams; j++) {
               ...
               beamStatus = din.readByte();
               jammingTechKind = din.readByte();
               jammingTechCategory = din.readByte();
               jammingTechSubcategory = din.readByte();
               jammingTechSpec = din.readByte();
               ...
               System.out.println(LoggerUtil.prettyPrintField("beamStatus") + beamStatus);
               System.out.println(LoggerUtil.prettyPrintField("jammingTechKind") + jammingTechKind);
               System.out.println(LoggerUtil.prettyPrintField("jammingTechCategory") + jammingTechCategory);
               System.out.println(LoggerUtil.prettyPrintField("jammingTechSubcategory") + jammingTechSubcategory);
               System.out.println(LoggerUtil.prettyPrintField("jammingTechSpec") + jammingTechSpec);
               ...
               for (int k = 0; k < numberTargetsInTrackJam; k++) {
                  ...
                  trackJamEmitter = din.readByte();
                  trackJamBeamNumber = din.readByte();
                  ...
                  System.out.println(LoggerUtil.prettyPrintField("trackJamEmitter") + trackJamEmitter);
                  System.out.println(LoggerUtil.prettyPrintField("trackJamBeamNumber") + trackJamBeamNumber);
