...
public class Acknowledge_R {
   ...
   static public void processPDU(DatagramPacket packet, int pduCounter) {
      ...
      short origEntIDRef = 0;
      short recEntIDSite = 0;
      short recEntIDApp = 0;
      short recEntIDRef = 0;
      short ackFlag = 0;
      short responseFlag = 0;
      int requestID = 0;
      ...
      try {
         ...
         origEntIDRef = din.readShort();
         recEntIDSite = din.readShort();
         recEntIDApp = din.readShort();
         recEntIDRef = din.readShort();
         ackFlag = din.readShort();
         responseFlag = din.readShort();
         ...
         System.out.println(LoggerUtil.prettyPrintField("origEntIDRef") + origEntIDRef);
         ...
         System.out.println(LoggerUtil.prettyPrintField("recEntIDRef") + recEntIDRef);
         System.out.println(LoggerUtil.prettyPrintField("ackFlag") + ackFlag);
         System.out.println(LoggerUtil.prettyPrintField("responseFlag") + responseFlag);
