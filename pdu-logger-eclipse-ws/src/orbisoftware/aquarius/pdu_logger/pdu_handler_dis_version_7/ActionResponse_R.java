...
public class ActionResponse_R {
   ...
   static public void processPDU(DatagramPacket packet, int pduCounter) {
      ...
      short origEntRefNum = 0;
      short recEntIDSite = 0;
      short recEntIDApp = 0;
      short recEntRefNum = 0;
      int requestID = 0;
      int requestStatus = 0;
      ...
      try {
         ...
         origEntRefNum = din.readShort();
         recEntIDSite = din.readShort();
         recEntIDApp = din.readShort();
         recEntRefNum = din.readShort();
         requestID = din.readInt();
         requestStatus = din.readInt();
         ...
         System.out.println(LoggerUtil.prettyPrintField("origEntRefNum") + origEntRefNum);
         ...
         System.out.println(LoggerUtil.prettyPrintField("recEntRefNum") + recEntRefNum);
         System.out.println(LoggerUtil.prettyPrintField("requestID") + requestID);
         System.out.println(LoggerUtil.prettyPrintField("requestStatus") + requestStatus);
         ...
         for (int j = 0; j < numberVariableDatumRecs; j++) {
            ...
            variableDatumValue = din.readInt();
