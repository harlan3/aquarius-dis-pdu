...
public class RepairResponse {
   ...
   static public void processPDU(DatagramPacket packet, int pduCounter) {
      ...
      try {
         ...
         System.out.println("   repairEntIDSite : " + repairEntIDSite);
         System.out.println("    repairEntIDApp : " + repairEntIDApp);
         System.out.println(" repairEntIDEntity : " + repairEntIDEntity);
         System.out.println("      repairResult : " + repairResult);
