...
public class ActionResponse {
   ...
   static public void processPDU(DatagramPacket packet, int pduCounter) {
      ...
      try {
         ...
         System.out
               .println("   numberFixedDatumRecs : " + numberFixedDatumRecs);
         System.out.println("numberVariableDatumRecs : "
               + numberVariableDatumRecs);
         ...
         for (int i = 0; i < numberFixedDatumRecs; i++) {
            ...
            System.out.println("           fixedDatumID : " + fixedDatumID);
            System.out.println("        fixedDatumValue : " + fixedDatumValue);
         }
         ...
         for (int j = 0; j < numberVariableDatumRecs; j++) {
            ...
            System.out.println("        variableDatumID : " + variableDatumID);
            System.out.println("    variableDatumLength : "
                  + variableDatumLength);
         }
