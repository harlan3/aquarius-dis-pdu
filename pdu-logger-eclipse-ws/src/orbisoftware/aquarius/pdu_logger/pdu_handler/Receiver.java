...
public class Receiver {
   ...
   static public void processPDU(DatagramPacket packet, int pduCounter) {
      ...
      try {
         ...
         System.out.println("             receiverState : " + receiverState);
         System.out.println("             receivedPower : " + receivedPower);
         System.out
               .println("         transEntityIDSite : " + transEntityIDSite);
         System.out.println("          transEntityIDApp : " + transEntityIDApp);
         System.out.println("       transEntityIDEntity : "
               + transEntityIDEntity);
         System.out.println("              transRadioID : " + transRadioID);
