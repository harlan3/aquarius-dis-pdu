...
public class StartResume {
   ...
   static public void processPDU(DatagramPacket packet, int pduCounter) {
      ...
      try {
         ...
         System.out.println("            rwtHour : " + rwtHour);
         System.out.println("    rwtTimePastHour : " + rwtTimePastHour);
         System.out.println("        simTimeHour : " + simTimeHour);
         System.out.println("simTimeTimePastHour : " + simTimeTimePastHour);
